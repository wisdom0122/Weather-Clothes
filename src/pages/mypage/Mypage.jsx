        ...
        <div className="informBoxTop">
          <div id ="informBoxTopleft">
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.9997 0.333332C19.2098 0.333332 21.3294 1.21131 22.8922 2.77411C24.455 4.33691 25.333 6.45653 25.333 8.66667C25.333 10.8768 24.455 12.9964 22.8922 14.5592C21.3294 16.122 19.2098 17 16.9997 17C14.7895 17 12.6699 16.122 11.1071 14.5592C9.54431 12.9964 8.66634 10.8768 8.66634 8.66667C8.66634 6.45653 9.54431 4.33691 11.1071 2.77411C12.6699 1.21131 14.7895 0.333332 16.9997 0.333332ZM16.9997 21.1667C26.208 21.1667 33.6663 24.8958 33.6663 29.5V33.6667H0.333008V29.5C0.333008 24.8958 7.79134 21.1667 16.9997 21.1667Z" fill="#3F8DED"/>
                </svg>
                <span style={text1}>내 정보</span>
          </div>
          <button style={modalButton} onClick={handleUpdateModal}>업데이트</button>
        </div>
